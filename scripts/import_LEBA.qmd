...
data |> 
  ...
  mutate(leba_f2_04 = fct_rev(leba_f2_04), 
         leba_f2 = rowSums(across(contains(factors_leba$F2), as.numeric), na.rm = TRUE),
         leba_f3 = rowSums(across(contains(factors_leba$F3), as.numeric), na.rm = TRUE),
         leba_f4 = rowSums(across(contains(factors_leba$F4), as.numeric), na.rm = TRUE),
         leba_f5 = rowSums(across(contains(factors_leba$F5), as.numeric), na.rm = TRUE),
         ) |> 
  mutate(leba_f2_04 = fct_rev(leba_f2_04)) |> 
